    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests(auth -> auth
                        ...
                        .antMatchers(HttpMethod.POST, "/api/v1/analytic/visit").permitAll()
                        .antMatchers(HttpMethod.POST, "/api/v1/analytic/social-link-click").permitAll()
                        .antMatchers(HttpMethod.POST, "/api/v1/analytic/custom-link-click").permitAll()
